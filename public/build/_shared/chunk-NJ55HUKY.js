import {
  Toast
} from "/build/_shared/chunk-QFR5PFXO.js";
import {
  API_BASE_URL
...
function links() {
  return [
    { rel: "stylesheet", href: "https://cdn.jsdelivr.net/npm/ag-grid-community/styles/ag-grid.css" },
    { rel: "stylesheet", href: "https://cdn.jsdelivr.net/npm/ag-grid-community/styles/ag-theme-alpine.css" }
  ];
}
...
function FoodWaste() {
  ...
  const [AgGridReact, setAgGridReact] = (0, import_react2.useState)(null);
  (0, import_react2.useEffect)(() => {
    setIsClient(true);
  }, []);
  (0, import_react2.useEffect)(() => {
    let mounted = true;
    import("/build/_shared/index.esm-2FS3DOYY.js").then((mod) => {
      if (!mounted)
        return;
      setAgGridReact(() => mod.AgGridReact || mod.default || null);
    }).catch(() => {
    });
    return () => {
      mounted = false;
  ...
  const referenceYear = (0, import_react2.useMemo)(() => {
  ...
  const recordsByDate = (0, import_react2.useMemo)(() => {
  ...
  const rowData = (0, import_react2.useMemo)(() => {
  ...
  const columnDefs = (0, import_react2.useMemo)(
    () => [
      { field: "weekDay", headerName: "Week Day", editable: false, sortable: false, resizable: true, width: 240 },
      { field: "number_of_users", headerName: "Users", editable: true },
      { field: "food_waste", headerName: "Food Waste (g)", editable: true },
      { field: "total_waste", headerName: "Total Waste (g)", editable: true }
    ],
    []
  );
  const onCellValueChanged = (0, import_react2.useCallback)((params) => {
    const { data, colDef, newValue } = params;
    const field = colDef.field;
    if (!NUMERIC_FIELD_KEYS.has(field))
      return;
    const parsed = Number(newValue);
    const normalized = newValue === "" || newValue === null || newValue === void 0 || Number.isNaN(parsed) ? null : parsed;
    handleUpdate(data.key, { date: data.date, [field]: normalized });
  }, [handleUpdate]);
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "p-6", children: [
    ...
    loading ? /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("p", { children: "Loading\u2026" }, void 0, false, {
      ...
      lineNumber: 201,
      columnNumber: 17
    }, this) : isClient && AgGridReact ? /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "ag-theme-alpine", style: { height: "340px", width: "100%" }, children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(
      AgGridReact,
      {
        rowData,
        columnDefs,
...
//# sourceMappingURL=/build/_shared/chunk-NJ55HUKY.js.map
