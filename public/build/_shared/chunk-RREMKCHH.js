import {
  Toast
} from "/build/_shared/chunk-V34EZNEI.js";
import {
  API_BASE_URL
} from "/build/_shared/chunk-37D2R22D.js";
import {
  Button
} from "/build/_shared/chunk-Y7ZDTCWU.js";
import {
  require_jsx_dev_runtime
} from "/build/_shared/chunk-4YF4PY3T.js";
import {
  require_react
...
function links() {
  return [
    { rel: "stylesheet", href: "https://cdn.jsdelivr.net/npm/@glideapps/glide-data-grid/dist/index.css" }
  ];
}
...
function FoodWaste() {
  ...
  const [DataEditor, setDataEditor] = (0, import_react2.useState)(null);
  (0, import_react2.useEffect)(() => {
    setIsClient(true);
  }, []);
  (0, import_react2.useEffect)(() => {
    let mounted = true;
    import("/build/_shared/esm-7UBMIAF4.js").then((mod) => {
      if (!mounted)
        return;
      setDataEditor(() => mod.default || mod.DataEditor || null);
    }).catch(() => {
    });
    return () => {
      mounted = false;
  ...
  const columns = (0, import_react2.useMemo)(() => {
    return [
      ...
      { id: "number_of_users", title: "Users" },
      { id: "food_waste", title: "Food Waste (g)" },
      { id: "total_waste", title: "Total Waste (g)" }
    ];
  }, []);
  const getCellContent = (0, import_react2.useCallback)((cell) => {
    const [col, row] = cell;
    const rowModel = rows[row];
    const colId = columns[col].id;
    const value = rowModel[colId];
    if (colId === "weekDay") {
      return {
        kind: "text",
        allowOverlay: false,
    ...
    return {
      ...
      data: value === "" ? void 0 : Number(value),
      allowOverlay: true
    };
  }, [rows, columns]);
  const onCellEdited = (0, import_react2.useCallback)((cell, newValue) => {
    const [col, row] = cell;
    const rowModel = rows[row];
    const colId = columns[col].id;
    if (!NUMERIC_FIELD_KEYS.has(colId))
      return;
    let normalized = null;
    if (newValue?.kind === "number") {
      const n = Number(newValue.data);
      normalized = Number.isNaN(n) ? null : n;
    } else if (newValue?.kind === "text") {
      const n = Number(newValue.data);
      normalized = newValue.data === "" || Number.isNaN(n) ? null : n;
    }
    handleUpdate(rowModel.key, { date: rowModel.date, [colId]: normalized });
  }, [rows, columns, handleUpdate]);
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "p-6", children: [
    ...
    loading ? /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("p", { children: "Loading\u2026" }, void 0, false, {
      ...
      lineNumber: 217,
      columnNumber: 17
    }, this) : isClient && DataEditor ? /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { style: { height: "340px", width: "100%" }, children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(
      DataEditor,
      {
        columns,
        rows: rows.length,
...
//# sourceMappingURL=/build/_shared/chunk-RREMKCHH.js.map
