...
function links() {
  return [{ rel: "stylesheet", href: "https://unpkg.com/react-data-grid@7.0.0-beta.56/lib/styles.css" }];
}
...
function FoodWaste() {
  ...
  const [DataGrid, setDataGrid] = (0, import_react2.useState)(null);
  (0, import_react2.useEffect)(() => {
    setIsClient(true);
  }, []);
  (0, import_react2.useEffect)(() => {
    let mounted = true;
    import("/build/_shared/lib-IQUKNC2K.js").then((mod) => {
      if (!mounted)
        return;
      setDataGrid(() => mod.default || mod.DataGrid || null);
    }).catch(() => {
    });
    return () => {
      mounted = false;
  ...
  const gridRows = (0, import_react2.useMemo)(() => {
  ...
  const handleRowsChange = (0, import_react2.useCallback)(
    (newRows, data) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "p-6", children: [
    ...
    loading ? /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("p", { children: "Loading\u2026" }, void 0, false, {
      ...
      lineNumber: 219,
      columnNumber: 17
    }, this) : isClient && DataGrid ? /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "border border-gray-300 rounded overflow-hidden", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(
      DataGrid,
      {
        rows: gridRows,
        columns,
...
//# sourceMappingURL=/build/_shared/chunk-NUSR3JUT.js.map
