...
function Login() {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "flex h-full items-center justify-center max-w-[600px] mx-auto p-6", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "flex flex-col items-center gap-6 w-full", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "flex justify-between gap-x-4 w-full", children: [
      "Login Account",
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("img", { src: "/images/iss_logo.webp", alt: "iss-logo", width: "" }, void 0, false, {
        fileName: "app/routes/login/index.jsx",
        lineNumber: 10,
        columnNumber: 21
      }, this)
...
//# sourceMappingURL=/build/_shared/chunk-REBCF3ZP.js.map
