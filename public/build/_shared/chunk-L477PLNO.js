...
function AdminLayout({ children }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "min-h-screen flex bg-gray-100 relative", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(
      "aside",
      {
        className: `bg-[var(--primary-color)] sticky p-4 top-0 h-full text-white transition-all duration-300 ${open ? "w-64" : "w-64"}`,
        children: [
...
//# sourceMappingURL=/build/_shared/chunk-L477PLNO.js.map
