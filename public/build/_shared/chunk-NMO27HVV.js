...
var require_Thumbs = __commonJS({
  "node_modules/react-responsive-carousel/lib/js/components/Thumbs.js"(exports) {
    ...
    var _reactEasySwipe = _interopRequireDefault(require_lib2());
...
// app/components/banner/bannerPopup.jsx
...
function BannerPopup(props) {
  const { setIsOpenParent, data, isAdminUser, modalIsOpenParent, calorie, co2 } = props;
  const [
    menuDk,
    menuEng,
    Allergens,
    ...
    data == null ? void 0 : data.menuInfo,
    data == null ? void 0 : data.menuInfo1,
    data == null ? void 0 : data.allergens,
    data == null ? void 0 : data.dietary,
    data == null ? void 0 : data.stationName,
    data == null ? void 0 : data.plateImg,
    data == null ? void 0 : data.stationId,
    data == null ? void 0 : data.locationId,
    data == null ? void 0 : data.stationUniqueId,
    data == null ? void 0 : data.RecipePlateImg,
    data == null ? void 0 : data.stationImage
  ];
  ...
  const copyText = ({ language, type }) => {
    ...
    (_a = navigator == null ? void 0 : navigator.clipboard) == null ? void 0 : _a.writeText(
      `${FRONTEND_URL}/banner/tablet-screen/${Number(
        stationUniqueId
      )}/${locationId}/${language}`
    );
  ...
  const renderSingleItem = ({ language }) => {
    arr.push(
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(tabContent_default, {
        menuDk,
        menuEng,
        Allergens,
        Dietary,
        stationImg,
        stationName,
        plateImg: plateImg !== null && plateImg !== void 0 && plateImg !== "" ? plateImg == null ? void 0 : plateImg.id : RecipePlateImg,
        showType: plateImg !== null && plateImg !== void 0 && plateImg !== "" ? plateImg == null ? void 0 : plateImg.showType : "id",
        copyText,
        language,
        isAdminUser,
        calorie,
        ...
        fileName: "app/components/banner/bannerPopup.jsx",
        lineNumber: 71,
        columnNumber: 7
      }, this)
    );
  ...
  const renderItems = () => {
    renderSingleItem({ language: "da" });
    renderSingleItem({ language: "en" });
    return arr;
  };
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
    ...
    children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(import_react_modal.default, {
      ...
      children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
        className: "w-full min-h-[86%] station-banner-preview",
        children: [
...
var bannerPopup_default = BannerPopup;
...
*/
//# sourceMappingURL=/build/_shared/chunk-NMO27HVV.js.map
