...
var createLucideIcon = (iconName, iconNode) => {
  const Component = (0, import_react2.forwardRef)(
    ({ className: className2, ...props }, ref) => (0, import_react2.createElement)(Icon, {
      ref,
      iconNode,
...
function Input({ children, type = "text", classNames = "", ...props }) {
...
function LoginPage() {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "flex flex-col items-center justify-center min-h-screen gap-4 relative p-4", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Form, { method: "post", className: "flex flex-col gap-6 max-w-[400px] w-full", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Input_default, { type: "email", required: true, name: true, placeholder: "Email" }, void 0, false, {
        fileName: "app/routes/login/index.jsx",
        lineNumber: 92,
        columnNumber: 17
      }, this),
...
//# sourceMappingURL=/build/_shared/chunk-TK6COUM2.js.map
