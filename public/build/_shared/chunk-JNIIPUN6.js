...
function LoginPage() {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "flex flex-col items-center justify-center gap-4 relative p-4", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("img", { src: "/images/sous-chef.svg", alt: "", width: "100px" }, void 0, false, {
      fileName: "app/routes/login/index.jsx",
      lineNumber: 81,
      columnNumber: 13
    }, this),
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "flex items-center justify-between w-full max-w-[600px]", children: [
      "Login",
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Form, { method: "post", className: "flex flex-col gap-6 max-w-[600px] w-full", children: [
...
//# sourceMappingURL=/build/_shared/chunk-JNIIPUN6.js.map
