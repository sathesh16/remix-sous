import {
  require_react_dom
} from "/build/_shared/chunk-4IIAECPM.js";
import {
  require_jsx_runtime
...
function renderToggleGroup(props) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ToggleGroup, { ...props });
}
function ToggleGroup({ groupKey, isExpanded, tabIndex, toggleGroup }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
    ...
    children: [groupKey, /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
      viewBox: "0 0 14 8",
      width: "14",
      height: "8",
...
function HeaderRenderer(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectCellFormatter, {
...
var SelectColumn = {
  ...
  renderHeaderCell(props) {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(HeaderRenderer, { ...props });
  },
  renderCell(props) {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectFormatter, { ...props });
  },
  renderGroupCell(props) {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectGroupFormatter, { ...props });
  }
};
...
function TreeDataGrid({ columns: rawColumns, rows: rawRows, rowHeight: rawRowHeight, rowKeyGetter: rawRowKeyGetter, onCellKeyDown: rawOnCellKeyDown, onCellCopy: rawOnCellCopy, onCellPaste: rawOnCellPaste, onRowsChange, selectedRows: rawSelectedRows, onSelectedRowsChange: rawOnSelectedRowsChange, renderers, groupBy: rawGroupBy, rowGrouper, expandedGroupIds, onExpandedGroupIdsChange, groupIdGetter: rawGroupIdGetter, ...props }) {
  ...
  const { columns, groupBy } = (0, import_react.useMemo)(() => {
    ...
    const groupBy$1 = [];
    for (const [index, column] of columns$1.entries())
  ...
  const getParentRowAndIndex = (0, import_react.useCallback)((row$1) => {
    ...
    for (let i = rowIdx - 1; i >= 0; i--) {
      ...
      if (isGroupRow(parentRow) && (!isGroupRow(row$1) || row$1.parentId === parentRow.id))
        return [parentRow, i];
    }
    return void 0;
  }, [isGroupRow, rows]);
  ...
  function onSelectedRowsChange(newSelectedRows) {
    ...
    for (const row$1 of rows) {
      ...
      if (selectedRows?.has(key) && !newSelectedRows.has(key))
        if (isGroupRow(row$1))
          for (const cr of row$1.childRows)
  ...
  function renderRow(key, { row: row$1, rowClass, onCellMouseDown, onCellClick, onCellDoubleClick, onCellContextMenu, onRowChange, lastFrozenColumnIndex, draggedOverCellIdx, selectedCellEditor, ...rowProps }) {
    if (isGroupRow(row$1)) {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(GroupRow_default, {
        ...rowProps,
...
//# sourceMappingURL=/build/_shared/lib-IQUKNC2K.js.map
