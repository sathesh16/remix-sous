...
function LoginPage() {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "flex flex-col items-center justify-center min-h-screen gap-4 relative p-4", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Form, { method: "post", act: true, className: "flex flex-col gap-6 max-w-[400px] w-full", children: [
...
//# sourceMappingURL=/build/_shared/chunk-XFOLULRL.js.map
