...
var Toast = (0, import_react7.forwardRef)((props, ref) => {
  const [isClosed, setIsClosed] = (0, import_react7.useState)(false);
  const [isRemoved, setIsRemoved] = (0, import_react7.useState)(false);
  const provider = useThemeProvider();
  const theme = useResolveTheme(
...
//# sourceMappingURL=/build/_shared/chunk-GRQAPTN3.js.map
