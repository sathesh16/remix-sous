import {
  Toast
} from "/build/_shared/chunk-6D43HBEY.js";
import {
  API_BASE_URL
} from "/build/_shared/chunk-37D2R22D.js";
import {
  Button
} from "/build/_shared/chunk-KDSGW5EK.js";
import {
...
var import_weekday2 = __toESM(require_weekday());
...
var NUMERIC_FIELD_KEYS = ["number_of_users", "food_waste", "total_waste"];
function links() {
  return [
...
function FoodWaste() {
  ...
  const [Spreadsheet, setSpreadsheet] = (0, import_react2.useState)(null);
  const [sheetData, setSheetData] = (0, import_react2.useState)([]);
  (0, import_react2.useEffect)(() => {
    setIsClient(true);
  }, []);
  (0, import_react2.useEffect)(() => {
    let mounted = true;
    import("/build/_shared/es-FEATO74W.js").then((mod) => {
      if (!mounted)
        return;
  ...
  const recordsByDate = (0, import_react2.useMemo)(() => {
    ...
    filteredRecords.forEach((item) => {
      const iso = (0, import_dayjs2.default)(item.date).format("YYYY-MM-DD");
      map.set(iso, item);
    });
    return map;
  }, [filteredRecords]);
  const mondayOfWeek = (0, import_react2.useMemo)(() => (0, import_dayjs2.default)().week(Number(week)).weekday(1), [week]);
  const rowModels = (0, import_react2.useMemo)(() => {
  ...
  const columnLabels = (0, import_react2.useMemo)(() => ["Users", "Food Waste (g)", "Total Waste (g)"], []);
  const rowLabels = (0, import_react2.useMemo)(() => WEEKDAYS, []);
  const handleSheetChange = (0, import_react2.useCallback)((newData) => {
    ...
    for (let r = 0; r < maxRows; r++) {
      ...
      for (let c = 0; c < NUMERIC_FIELD_KEYS.length; c++) {
        ...
        if (prevVal !== nextVal) {
          ...
          const normalized = nextVal === "" || nextVal === null || nextVal === void 0 || Number.isNaN(parsed) ? null : parsed;
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "p-6", children: [
    ...
    loading ? /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("p", { children: "Loading\u2026" }, void 0, false, {
      ...
      lineNumber: 165,
      columnNumber: 17
    }, this) : isClient && Spreadsheet ? /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "border border-gray-300 rounded overflow-hidden w-full", style: { width: "100%" }, children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(
      Spreadsheet,
      {
        data: sheetData,
...
//# sourceMappingURL=/build/routes/admin/kitchen.foodwaste-V32FFS7C.js.map
