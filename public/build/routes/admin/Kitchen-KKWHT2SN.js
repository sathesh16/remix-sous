import {
  AdminLayout
} from "/build/_shared/chunk-SAPX5Z3Y.js";
import {
  API_BASE_URL
...
function isEqual(a2, b) {
  ...
  if (a2 && b && typeof a2 === "object" && typeof b === "object") {
    ...
    if (Array.isArray(a2)) {
      ...
      return a2.every((item, index) => isEqual(item, b[index]));
    }
    ...
    return aKeys.every((key) => Object.prototype.hasOwnProperty.call(b, key) && isEqual(a2[key], b[key]));
  }
  return a2 !== a2 && b !== b;
}
...
function ProductsTable() {
  ...
  function handleSort(field) {
    ...
    if (field === "category") {
      setCategories(
        (prev) => [...prev].sort((a2, b) => {
          const res = a2.name.localeCompare(b.name);
  ...
  function sortedProducts(category) {
    ...
    return sortBy === "name" ? [...list].sort((a2, b) => {
      const res = a2.name.localeCompare(b.name);
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { className: "p-6 bg-gray-50 min-h-screen", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { className: "flex justify-between mb-6", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("p", { className: "text-2xl", children: "Products Overview" }, void 0, false, {
...
//# sourceMappingURL=/build/routes/admin/Kitchen-KKWHT2SN.js.map
