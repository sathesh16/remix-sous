...
function PreviewModal({ open, onClose, data, screen, setScreen }) {
  if (!open)
    return null;
  return /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50 regular-text", children: /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "w-[1080px] p-4 max-h-[1920px] overflow-y-auto svg-bg bg-[var(--banner-bg-color)]", children: /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "menu-wrapper p-6 pt- text-[var(--banner-text-color)] rounded-tr-[50px] rounded-br-[50px]", children: [
...
//# sourceMappingURL=/build/routes/admin/Kitchen-LAXB4GST.js.map
