...
function Toggle({ apiOn = false }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(
    ...
    {
      onClick: () => setOn(!on),
      className: `w-22 h-8 rounded-full flex items-center px-1 relative transition-all duration-200 ${on ? "bg-[var(--primary-color)]" : "bg-gray-300"}`,
      children: [
...
//# sourceMappingURL=/build/routes/admin/Kitchen-DZDDGHBL.js.map
