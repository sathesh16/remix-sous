...
function PreviewModal({ open, onClose, data, screen, setScreen }) {
  if (!open)
    return null;
  return /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50", children: /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "bg-[var(--banner-text-color)] w-[1200px] p-4 max-h-[80vh] overflow-y-auto", children: /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "menu-wrapper p-6 bg-[var(--banner-text-color)]", children: [
...
//# sourceMappingURL=/build/routes/admin/Kitchen-GJLZ6S6A.js.map
