...
function CopyLinkButton({}) {
  ...
  const handleCopy = (0, import_react8.useCallback)(async () => {
    ...
    try {
      ...
      setCopyStatus("Copied! \u{1F389}");
      setTimeout(() => {
        setCopyStatus("Copy Link");
      }, 2e3);
    } catch (err) {
      console.error("Failed to copy text: ", err);
      setCopyStatus("Failed to copy \u{1F614}");
      setTimeout(() => {
        setCopyStatus("Copy Link");
      }, 2e3);
    }
...
function PreviewModal({ open, onClose, data, screen, setScreen, screenNumber: screenNumber2 }) {
  if (!open)
    return null;
      ...
      children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(
        "div",
        {
          ...
          children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { className: "menu-wrapper p-6 pt-12 text-[var(--banner-text-color)] rounded-tr-[50px] rounded-br-[50px]", children: [
            ...
            /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { className: "flex justify-center mb-4", children: [
              /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(
                Link,
                {
                  to: `/banner/product/1/${screenNumber2}`,
                  className: "text-blue-600 underline text-sm",
              ...
              /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(CopyLinkButton_default, { screenNumber: screenNumber2 }, void 0, false, {
                fileName: "app/components/PreviewModal.jsx",
                lineNumber: 53,
                columnNumber: 25
              }, this)
...
function ProductsTable() {
  const [showExitDialog, setShowExitDialog] = (0, import_react11.useState)(false);
  const [nextLocation, setNextLocation] = (0, import_react11.useState)(null);
  ...
  const [sortBy, setSortBy] = (0, import_react11.useState)(null);
  const [sortDirection, setSortDirection] = (0, import_react11.useState)("asc");
  ...
  const [updates, setUpdates] = (0, import_react11.useState)({});
...
//# sourceMappingURL=/build/routes/admin/Kitchen-LI3INZWZ.js.map
