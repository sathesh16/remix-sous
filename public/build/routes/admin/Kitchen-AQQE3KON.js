...
function AdminLayout({ children }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "min-h-screen flex bg-gray-100", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(
      "aside",
      {
        className: `bg-gray-800 absolute top-0 text-white w-[200px] transition-all duration-300 ${open ? "left-0" : "left-64"}`,
        children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(
            "button",
            {
...
//# sourceMappingURL=/build/routes/admin/Kitchen-AQQE3KON.js.map
