...
function ProductsTable() {
  ...
  (0, import_react10.useEffect)(() => {
    if (!hasUnsavedChanges) {
      alert("false for unsaved changes");
      return;
    }
    alert("true for saved change1");
    if (transition.state === "loading") {
      alert("true for saved change2");
  ...
  }, [transition.state, hasUnsavedChanges, navigate, location]);
  (0, import_react10.useEffect)(() => {
    const handler = (e) => {
      if (!hasUnsavedChanges)
        return;
...
//# sourceMappingURL=/build/routes/admin/Kitchen-ZZP77E2S.js.map
