...
function ProductsTable() {
  ...
  const [showPreviewModal, setShowPreviewModal] = (0, import_react8.useState)(false);
  const [previewScreen, setPreviewScreen] = (0, import_react8.useState)("screen1");
  /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(Button, { variant: "secondary", onClick: () => {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "bg-white rounded-lg shadow overflow-hidden border border-gray-300", children: /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("table", { className: "min-w-full border-collapse text-sm", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("tbody", { className: "divide-y divide-gray-200", children: sortedCategories.map((category) => {
        ...
        return categoryProducts.map((product, index) => /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("tr", { className: "border-b hover:bg-gray-50", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("td", { className: "p-3", children: /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "flex flex-col gap-y-4", children: [
            /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(
              "textarea",
              {
...
//# sourceMappingURL=/build/routes/admin/Kitchen-E3NV52BY.js.map
