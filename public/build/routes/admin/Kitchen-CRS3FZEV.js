...
function CopyLinkButton({ screenNumber }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(
    ...
    {
      onClick: handleCopy,
      className: "text-blue-600 bg-[var(--banner-text-color)] text-[var(--banner-text-color)] underline text-sm",
...
//# sourceMappingURL=/build/routes/admin/Kitchen-CRS3FZEV.js.map
