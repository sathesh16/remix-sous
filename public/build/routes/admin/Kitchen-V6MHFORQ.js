...
function Toggle({ apiOn = false }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(
    ...
    {
      onClick: () => setOn(!on),
      className: `w-12 h-6 rounded-full flex items-center transition-all duration-200 ${on ? "bg-[]" : "bg-gray-300"}`,
...
//# sourceMappingURL=/build/routes/admin/Kitchen-V6MHFORQ.js.map
