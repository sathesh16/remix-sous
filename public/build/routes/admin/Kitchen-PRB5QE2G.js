...
function AdminLayout({ children }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "min-h-screen flex bg-gray-100", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(
      "aside",
      {
        className: `bg-gray-800 absolute text-white transition-all duration-300 ${open ? "w-64" : "w-0"}`,
        children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(
            "button",
            {
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("nav", { className: "p-2 space-y-2", children: [
            ...
            /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Link, { to: "/admin/kitchen", className: "block px-3 py-2 hover:bg-gray-700" }, void 0, false, {
              fileName: "app/components/AdminLayout.jsx",
              lineNumber: 24,
              columnNumber: 21
            }, this)
...
//# sourceMappingURL=/build/routes/admin/Kitchen-PRB5QE2G.js.map
