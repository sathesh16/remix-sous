...
function AdminLayout({ children }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "min-h-screen flex bg-gray-100", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(
      "aside",
      {
        className: `bg-gray-800 absolute top-0 h-full text-white transition-all duration-300 ${open ? "w-64" : "w-0"}`,
        children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(
            "button",
            {
...
//# sourceMappingURL=/build/routes/admin/Kitchen-M7WHEZ6O.js.map
