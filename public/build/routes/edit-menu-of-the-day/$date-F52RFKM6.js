...
var EditMenuModel = import_react3.default.forwardRef((prop, _ref) => {
  ...
  (ingredient == null ? void 0 : ingredient.length) > 0 && (ingredient == null ? void 0 : ingredient.map((e) => {
    ...
    console.log((_b2 = (_a2 = e == null ? void 0 : e.Item1) == null ? void 0 : _a2.CO2e) == null ? void 0 : _b2.replace(",", "."), (_d2 = (_c2 = e == null ? void 0 : e.Item1) == null ? void 0 : _c2.energy) == null ? void 0 : _d2.replace(",", "."));
    ((_e2 = e == null ? void 0 : e.Item1) == null ? void 0 : _e2.CO2e) != null && ((_f2 = e == null ? void 0 : e.Item1) == null ? void 0 : _f2.CO2e) != void 0 && (totalCO2 = Number((_h2 = (_g2 = e == null ? void 0 : e.Item1) == null ? void 0 : _g2.CO2e) == null ? void 0 : _h2.replace(",", ".")) / 1e3 * Number(e == null ? void 0 : e.Value2) + totalCO2);
    ((_i2 = e == null ? void 0 : e.Item1) == null ? void 0 : _i2.energy) != null && ((_j2 = e == null ? void 0 : e.Item1) == null ? void 0 : _j2.energy) != void 0 && (totalCalories = Number((_l2 = (_k2 = e == null ? void 0 : e.Item1) == null ? void 0 : _k2.energy) == null ? void 0 : _l2.replace(",", ".")) / 100 * 0.239006 * Number(e == null ? void 0 : e.Value2) + totalCalories);
    return "";
  }));
  console.log("totalCO2:", totalCO2, "totalCalories", totalCalories);
  ...
  const AllergensTable = () => {
    ...
    return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
      ...
      children: [
        ...
        ingredientChanged && /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
          className: "text-red-500 text-sm text-right py-2",
          children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("button", {
            onClick: () => setIngredientChanged(false),
            className: " min-h-[30px] inline-flex items-center justify-center border border-transparent bg-primary text-sm font-medium text-white shadow-sm hover:bg-primary focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 sm:w-auto px-4",
            children: "Confirm"
          }, void 0, false, {
            fileName: "app/components/edit/editMenuModel.jsx",
            lineNumber: 324,
  ...
  const recipeUpdate = async ({
    ...
    const body = {
      ...
      total_co2: co2 != null ? co2 : 0,
      total_calories: calorie != null ? calorie : 0
    };
    console.log("called 1", co2, calorie, Id);
    ...
    if (!((_a2 = ingredient == null ? void 0 : ingredient.map((e) => {
      ...
      if (!((_b2 = ingredient == null ? void 0 : ingredient.map((e) => {
        ...
        if (!ingredientChanged) {
          ...
          Q.error("Please confirm the pre-selected allergens");
  ...
  ({
    ...
    const [totalCalorie, setTotalCalorie] = (0, import_react4.useState)(
      existingTableData.some((data) => {
        ...
        co2: ((_n = stationMenu == null ? void 0 : stationMenu.recipe_id) == null ? void 0 : _n.total_co2) != null ? (_p = Number((_o = stationMenu == null ? void 0 : stationMenu.recipe_id) == null ? void 0 : _o.total_co2)) == null ? void 0 : _p.toFixed(2) : null
      } : {
        calories: null,
        co2: null
      }
    );
    console.log("Base totalCalorie:", totalCalorie);
...
@license MIT
*/
//# sourceMappingURL=/build/routes/edit-menu-of-the-day/$date-F52RFKM6.js.map
